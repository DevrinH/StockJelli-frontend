...
setSegmented(document.getElementById("accountBrokerControl"), data.preferredBroker || "tradingview");
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // UPDATED: Region control — no longer caps frequency at 3 for global
  // ═══════════════════════════════════════════════════════════════════════════
  regionControl?.addEventListener("click", (e) => {
    ...
    updateRegionHint();
    updateFreqHint();
    // No frequency cap — both regions support 1–8 + unlimited
  });
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // UPDATED: Save preferences — no longer caps freq at 3 for global
  // ═══════════════════════════════════════════════════════════════════════════
  saveBtn?.addEventListener("click", async () => {
    ...
    // No cap — send raw value (1–8 or 99)
